      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <?php 
               $v= $_GET['cid'];
               $query= mysqli_query($con, "SELECT * FROM staff WHERE `id` = $v");
                ...
                <div class="callout callout-danger with-border">
                 <form method="post" action="">
                    <div class="box-body no-padding">
                      ...
                      <h5>Department:<?php  echo  $qq['postion']."(". $qq['department']?> )</h5>

                    </div>
                    <div class="box-footer text-center">
                      <button class="btn btn-outline-danger btn-sm" name="btn_del">Yes,Delete</button> &nbsp; &nbsp;
                      <a href="staff.php" class="btn btn-outline-success" title="Back to Visitors list">Cancel</a>
                    </div>
                 </form>
            ...
            <?php }else{
                //$v= $_GET['cid'];
                $q= mysqli_query($con,"DELETE FROM staff WHERE `id`='$v'");
                if(mysqli_affected_rows($con)){
                   
                     echo'  <div class="card">
                            <div class="card-body"><h4> <div class="alert alert-success">
                              <span class="fa fa-check"></span> Success!</h4> 
                              <p>Staff  has been deleted!</p>
                              <a href="staff.php" class="btn btn-outline-success" title="Back to Users list">Back To List</a>
                            </div>
                            </div>
                            </div>';
                }else{
